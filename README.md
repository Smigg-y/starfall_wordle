![Wordle](https://github.com/Smigg-y/starfall_wordle/blob/ease-of-use/assets/wordle_combined.jpg "Wordle")
# Wordle
...
Edit the top of `wordle.lua`. You must update **both** the `@include` directives and the `Language` variable to the same language code, otherwise the script will error.
